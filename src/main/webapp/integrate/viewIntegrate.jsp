    	...
    	<table border=1>
    		...
    		<s:iterator value="integrates">
    			<tr>
    				...
    				<td>
    					<s:url id="deleteIntegrate" action="deleteIntegrate">
    						<s:param name="integrateId" value="integrateId"/>
    					</s:url>
    					<s:a href="%{deleteIntegrate}" onclick="return confirm('确定要删除吗？')" >删除</s:a>
    					<s:url id="updateIntegrate" action="updateIntegrate">
    						<s:param name="integrateId" value="integrateId"/>
    					</s:url>
    					<s:a href="%{updateIntegrate}">修改</s:a>
    				</td>
    			</tr>
    		</s:iterator>
    	</table>
